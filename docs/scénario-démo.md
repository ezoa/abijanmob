...
Durée conseillée : **7–10 minutes** + questions. Répété au moins deux fois avant le jour J.

## 0. Avant de commencer (checklist)

- [ ] `bash demo/demo.sh` lancé → http://127.0.0.1:4173 ouvert dans Chrome/Firefox
- [ ] Mode plein écran (bouton ⛶) si projection ; F11 pour le navigateur
- [ ] Vérifier la page d'accueil : carte du réseau visible, 14 lieux proposés
...
4. Montrer la carte : le réseau complet (cliquer une ligne → tarif et fréquence).
...
## 3. Piliter PAIEMENT (3 min) — « zéro monnaie, zéro friction »
...
## 4. La boucle données (1 min) — le cœur de l'innovation
...
## 5. Conclusion (1 min) — vision et faisabilité
...
## 6. Transparence — questions probables du jury
